                  ...
                  <tbody>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Helvetica, Arial, sans-serif;font-size:28px;font-weight:bold;line-height:1;text-align:left;color:#333333;">Payment Receipt</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;">Thank you for your payment. Here are the details of your transaction:</div>
                      </td>
                    </tr>
                    <tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="direction:ltr;font-size:0px;padding:10px;text-align:center;">
                                  ...
                                  <div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000; padding-bottom: 15px;"><strong>Description:</strong><br />
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;">Best regards,<br /> Your Company Name</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
